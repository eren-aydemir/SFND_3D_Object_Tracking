...
int main(int argc, const char *argv[])
{
    ...
    /*
    vector<string> DETECTORTYPEVEC = {"FAST", "BRISK", "ORB", "SIFT"};
    vector<string> DESCRIPTORTYPEVEC = {"BRISK", "BRIEF", "ORB", "FREAK", "SIFT"};
    vector<string> MATCHERTYPEVEC = {"MAT_BF", "MAT_FLANN"};
    vector<string> SELECTORTYPEVEC = {"SEL_NN", "SEL_KNN"};
    */
    
    vector<string> DETECTORTYPEVEC = {"SIFT"};
    vector<string> DESCRIPTORTYPEVEC = {"FREAK"};
    vector<string> MATCHERTYPEVEC = {"MAT_BF", "MAT_FLANN"};
    vector<string> SELECTORTYPEVEC = {"SEL_NN", "SEL_KNN"};

    for (int i = 0; i < DETECTORTYPEVEC.size(); i++)
    {
        for (int j = 0; j < DESCRIPTORTYPEVEC.size(); j++)
        {
            for (int k = 0; k < MATCHERTYPEVEC.size(); k++)
            {
                for (int l = 0; l < SELECTORTYPEVEC.size(); l++)
                {       
                    string DETECTORTYPE = DETECTORTYPEVEC[i];
                    string DESCRIPTORTYPE = DESCRIPTORTYPEVEC[j];
                    string MATCHERTYPE = MATCHERTYPEVEC[k];
                    string SELECTORTYPE = SELECTORTYPEVEC[l];
                    string cout_name = DETECTORTYPE + "-" + DESCRIPTORTYPE + "-" + MATCHERTYPE + "-" + SELECTORTYPE;
                    cout << "----------------------" << endl;
                    cout << cout_name << endl;
                    cout << "----------------------" << endl;

                    if ((DETECTORTYPE == "SHITOMASI") && (DESCRIPTORTYPE == "BRIEF") && (MATCHERTYPE == "MAT_BF"))
                    {
                        cout << "here" << endl;
                        break;
                    }
                    ...
                    /*
                    if ((DETECTORTYPE == "BRISK") && (DESCRIPTORTYPE != "FAST"))
                    {
                        break;
                    }
                    */
                    ...
                    myFile << "Detector Type, Descriptor Type, Matcher Type, Selector Type, ttcLidar, ttcCamera\n";
